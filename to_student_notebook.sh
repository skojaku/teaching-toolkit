...
sed -e 's/^# \+$/# + tags=["non-grading"]/' $teacher_notebook_py > $teacher_notebook_py_tagged
...
rm $teacher_notebook_py
rm $teacher_notebook_py_tagged
rm $teacher_notebook_ipynb_tagged
